...
export class LiftStructurePreviewService {
	...
	public resetLiftStructurePreview(): void {
		...
		this.liftStructureModelHolder.FindFirstChildOfClass("Model")?.Destroy();

		for (const undergroundStructureModel of this.liftStructureModelHolder.GetChildren()) {
