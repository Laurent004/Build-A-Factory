...
export default class BaseStructureHighlightService {
	...
	public initStructureHighlight(model: Model): void {
		this.highlight.Adornee = model;
		this.highlight.FillColor = this.cannotPlaceHighlightFillColor;
		this.highlight.OutlineColor = this.cannotPlaceHighlightOutlineColor;
		this.highlight.Enabled = true;
	}

	public updateStructureHighlight(canPlace: boolean): void {
	...
	public resetStructureHighlight(): void {
